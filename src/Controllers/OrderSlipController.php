...
use App\Repositories\OrderSlipRepository;
use App\Support\Exceptions\HttpException;
use RuntimeException;

final class OrderSlipController
{
    public function __construct(private readonly OrderSlipRepository $repo)
    {
    }
    ...
    public function list(array $params = [], array $query = [], array $body = []): array
    {
        ...
        return $this->repo->listOrderSlips($mainId, $month, $year, $status, $search, $dateFrom, $dateTo, $page, $perPage);
    }
    ...
    public function show(array $params = [], array $query = [], array $body = []): array
    {
        ...
        $orderSlipRefno = trim((string) ($params['orderSlipRefno'] ?? ''));
        if ($orderSlipRefno === '') {
            throw new HttpException(422, 'orderSlipRefno is required');
        }

        $record = $this->repo->getOrderSlip($mainId, $orderSlipRefno);
        if ($record === null) {
            throw new HttpException(404, 'Order slip not found');
        }
    ...
    public function create(array $params = [], array $query = [], array $body = []): array
    {
        ...
        try {
            return $this->repo->createOrderSlip($mainId, $userId, $body);
    ...
    public function update(array $params = [], array $query = [], array $body = []): array
    {
        ...
        try {
            $record = $this->repo->updateOrderSlip($mainId, $orderSlipRefno, $body);
        } catch (RuntimeException $e) {
            throw new HttpException(422, $e->getMessage());
        }
        if ($record === null) {
    ...
    public function delete(array $params = [], array $query = [], array $body = []): array
    {
        ...
        $deleted = $this->repo->cancelOrderSlip($mainId, $orderSlipRefno, (string) ($query['reason'] ?? ''));
        if (!$deleted) {
            throw new HttpException(404, 'Order slip not found');
        }
    ...
    public function addItem(array $params = [], array $query = [], array $body = []): array
    {
        ...
        try {
            return $this->repo->addItem($mainId, $userId, $orderSlipRefno, $body);
        } catch (RuntimeException $e) {
            throw new HttpException(422, $e->getMessage());
        }
    }
    ...
    public function updateItem(array $params = [], array $query = [], array $body = []): array
    {
        ...
        if ($item === null) {
            throw new HttpException(404, 'Order slip item not found');
        }
    ...
    public function action(array $params = [], array $query = [], array $body = []): array
    {
        ...
        try {
            $record = $this->repo->applyAction($mainId, $orderSlipRefno, $action, $body);
        } catch (RuntimeException $e) {
            throw new HttpException(422, $e->getMessage());
        }
        if ($record === null) {
